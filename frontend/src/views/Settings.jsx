...
export default function Settings() {
  ...
  return <div className="narrow">
    ...
    {/* ---------- general ---------- */}
    <Section title={t('General')} footer={t('Switching units converts displayed weights; stored data stays in kilograms.')}>
      <SelectRow
    ...
    <Section title={t('Data')}>
      ...
      <Row icon="trash" iconTint="var(--red)" title={t('Reset everything')} danger onClick={() => confirmSheet({ title: t('Reset everything?'), message: t('Deletes your plan, workouts and body weight on this device. This cannot be undone.'), confirmText: t('Delete everything'), danger: true, onConfirm: () => { replaceState(DEF, true); nav('/home'); toast(t('All data reset')) } })} />
    </Section>
